<?php
session_start();
//jika tidak ada aktivitas pelanggan, maka login terlebih dahulu.
if(!isset($_SESSION['log'])){
	header('location:login.php');
}
//jika ada aktivitas pelanggan, maka tampilkan halaman konfirmasi.
else {
...
//jika ada aktivitas konfirmasi dari pelanggan.
