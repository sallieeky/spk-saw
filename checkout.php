...
//jika tidak ada session pengguna atau member di dalam sistem checkout, maka lakukan login terlebih dahulu.
...
//jika ada session pengguna atau member di dalam sistem checkout, maka tampil halaman Checkout.
else {
...
//jika ada pengguna melakukan checkout produk di dalam sistem.	
if(isset($_POST["checkout"])){
	...
	//jika ada perubahan status "Cart" dalam pemesanan menjadi status "Waiting" tanpa kendala, maka beralih ke halaman Daftar Order.
	if($q3){
		echo "Berhasil Check Out
		<meta http-equiv='refresh' content='1; url= daftarorder.php'/>";

	//jika ada kesalahan sistem pada saat proses Checkout, maka beralih ke halaman Checkout.
	} else {
...
//jika tidak ada pengguna melakukan checkout produk di dalam sistem.
else {
		...
		<div class="container">
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<?php 
					//Menampilkan seluruh data checkout yang berdasarkan kode Order (orderid).
			...
			<?php 
			//jika pengguna ada belanja produk, maka menghitung total seluruh belanja di sistem checkout.
