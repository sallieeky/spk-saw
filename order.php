...
//jika tidak ada aktivitas pelanggan di sistem ini, maka login terlebih dahulu.
if(!isset($_SESSION['log'])){
	header('location:login.php');
} 
//jika ada aktivitas pelanggan di sistem ini, maka dapat memesan produk di sistem ini.
else {
	
};

//Menampilkan seluruh pesanan produk yang berdasarkan ID pelanggan dan ID Order.
$idorder = $_GET['id'];
		...
		<div class="container">
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<?php 
					//Menampilkan seluruh pesanan produk yang berdasarkan ID Order.
			...
			<div class="checkout-left" style="width: 100%">	
				<div style="width: 55%" class="checkout-left-basket">
					...
					<ul>
						<?php
						//Menampilkan total seluruh harga pesanan produk yang berdasarkan ID Order. 
						$brg = mysqli_query($conn,"SELECT * from detailorder d, produk p
												where orderid = '$idorder' 
												and d.idproduk = p.idproduk 
												order by d.idproduk ASC");
