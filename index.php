...
<!-- //navigation -->
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp">
								...
								<?php
								if(!isset($_SESSION['name'])){  //jika if(!isset($_SESSION['name'] sudah diset nilainya maka
									
								} else {
									echo 'Untukmu, '.$_SESSION['name'].'!';  // akan muncul nama dari user yang login
								}
								?>
								</h5>
								</div>
							<div class="agile_top_brands_grids">
								<?php 
								$brgs=mysqli_query($conn,"SELECT * from produk order by idproduk ASC limit 3 "); // mengambil data produk dan mengurutkan dari id terbesar ke kecil
								$no=1;
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp">
								...
								<?php
								//jika tidak ada nama pelanggan di dalam sistem, maka tidak muncul nama pelanggan sama sekali.
								if(!isset($_SESSION['name'])){
									
								}
								//jika ada nama pelanggan di dalam sistem, maka muncul nama pelanggan.
								else {
							...
							<div class="agile_top_brands_grids">
								<?php 
								//Menampilkan 3 data produk yang berdasarkan penilaian berdasarkan rekomendasi.
	...
	<?php
	//Query untuk Menampilkan 3 data produk yang terlaris di toko. 
   ...
   //jika ada data produk yang terlaris, maka muncul 3 data produk yang terlaris. 
					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp">
								...
								<?php
								//jika tidak ada data pelanggan di sistem ini, maka tidak muncul nama pelanggan sama sekali. 
								if(!isset($_SESSION['name'])){
									
								} 
								//jika tidak nama pelanggan di dalam sistem, maka muncul nama pelanggan. 
								else {
									echo 'Untukmu, '.$_SESSION['name'].'!';
								}
								?>
							...
							<div class="agile_top_brands_grids">
								<?php 
								$no=1;
								//Menampilkan 3 data produk yang terlaris di toko.
